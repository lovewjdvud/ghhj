...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Setting()
        //Sing.CodingKeys
      //  Sing.CodingKeys.wjdvud1.intValue = ""
...
//        path.updateData(["Array": []])
    //    let array =  []
        ...
        let wjdvud = ["whdvud":"wjdvud"]
        var test = db.collection("Test2").document("ExampleDocument1")
       // test.setData(["Map": ["id":wjdvud]])
      //  test.updateData(["Map": [:]])
                ...
                do {
                 if let document = document {
                   ...
                   // 디코딩
                    ...
                    let decodeData = try decoders.decode(BotData.self, from: jsonData)
                    print(decodeData.Map.id.wjdvud1)
